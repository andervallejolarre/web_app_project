        ...
        <>
            ...
            <section className="contact">
                <div className="contactGrid">
                    ...
                    <p>A project that explores plants through both ecological
                    ...
                    <h3>Social Media</h3>
                    <p>Our work is available in different digital platforms. You will find sound experiments, podcasts and
                        documentation about past installations.</p>
                    <div>
